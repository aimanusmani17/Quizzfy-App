...
//   const handleRemoveQues = (questionIndex) => {
//     const updatedQuestions = [...values.questionList];
...
//     setValues({ ...values, questionList: reorderedQuestions });
//   };

//   const handleUpdateQuiz = () => {
//     const token = localStorage.getItem("loginToken");
//     axios
//       .put(`https://quizzfy-app.onrender.com/quiz/${quizId}`, values, {
//         headers: {
//           Authorization: `Bearer ${token}`,
//         },
//       })
...
//               type="text"
//               name="category"
//               className={QuizStyles.quizCategory}
...
//               className={QuizStyles.quizDiffLevel}
...
//               className={QuizStyles.quizPrivacy}
//               onChange={handleInputChange}
//             >
...
const EditQuiz = () => {
  ...
  const handleRemoveQues = (questionIndex) => {
    ...
    // Reassign question numbers after removal
    const reorderedQuestions = updatedQuestions.map((q, idx) => ({
      ...q,
      questionNumber: idx + 1,
    }));
